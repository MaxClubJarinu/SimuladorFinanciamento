...
def add_corner_image(image_path: Path, width_px: int = 150, corner: str = "top-left",
                     offset_x: int = 50, offset_y: int = 70):
...
def login_screen():
    ...
    add_corner_image(LOGO_PATH, width_px=170, corner="top-left")
    ...
    ok = col_a.button("Entrar", use_container_width=True)
    if ok:
